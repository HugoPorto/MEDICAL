...
public interface CaracteresEspeciaisAscII {
    ...
    public static final char U_CIRCUNFLEXO_LOWER_CASE = 233;
    ...
    public static final char A_AGUDO_UPPER_CASE = 143;
    public static final char A_CIRCUNFLEXO_UPPER_CASE = 131;
    ...
    public static final char E_CIRCUNFLEXO_UPPER_CASE = 136;
    ...
    public static final char U_AGUDO_UPPER_CASE = 163;
    public static final char U_CIRCUNFLEXO_UPPER_CASE = 233;
    public static final char U_GRAVE_UPPER_CASE = 235;
    public static final char operadorGenero = 248;
