 ...
 */
public class TelaCadastroLeitosApartamentos extends javax.swing.JFrame {
     ...
     */
    public TelaCadastroLeitosApartamentos() {
        initComponents();
...
//    
    ...
    public void SalvarLeito() {
        Conexao conec = new Conexao();
        String sql = "insert into tb_leitosapartamento(DataCadastro,leito,status)values(?,?,?)";
    ...
    public void alterarLeito() {
        Conexao conec = new Conexao();
        String sql = "update tb_leitosapartamento set DataCadastro=?,leito=?,status=? where codigo=?";
    ...
    public void removerLeito() {
        Conexao conec = new Conexao();
        String sql = "delete from tb_leitosapartamento where codigo=?";
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro Leitos Apartamentos");
        ...
        jLabel1.setText("Cadastro de Leitos Apartamentos");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(43, 43, 43))
                    .addComponent(jCStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel3Layout.createSequentialGroup()
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastroLeitosApartamentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroLeitosApartamentos().setVisible(true);
            }
        });
    }
