 ...
 */
public class TelaGeralPacientesIternadosEnfermagem extends javax.swing.JFrame {
     ...
     */
    public TelaGeralPacientesIternadosEnfermagem() {
        initComponents();
        listarCadastro();
        pintarColumnaTabla();
        setIcon();
    ...
    private void initComponents() {
        ...
        if (tabelaPacientes.getColumnModel().getColumnCount() > 0) {
            ...
            tabelaPacientes.getColumnModel().getColumn(8).setMinWidth(130);
            tabelaPacientes.getColumnModel().getColumn(8).setPreferredWidth(130);
            tabelaPacientes.getColumnModel().getColumn(8).setMaxWidth(130);
        }
...
//
    TelaAlterarLeitosPacientesInternados tela = new TelaAlterarLeitosPacientesInternados(this, true);
                ...
                String Acomodacao = model.getValueAt(index, 1).toString();
                tela.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                tela.txtProntuario.setText(Prontuario);
                tela.jCAcomodacao.setSelectedItem(Acomodacao);
                tela.jCAcomodacao.setEnabled(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaGeralPacientesIternadosEnfermagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaGeralPacientesIternadosEnfermagem().setVisible(true);
            }
        });
    }
