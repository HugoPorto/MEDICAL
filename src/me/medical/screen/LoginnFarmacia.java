 ...
 */
public class LoginnFarmacia extends javax.swing.JFrame {
...
//                    Singleton.setSala(jCSala.getSelectedItem().toString());
                    ...
                    TelaPrincipalFarmacia tela = new TelaPrincipalFarmacia();
    ...
    private void initComponents() {
        ...
        jPanel2.add(btnEntrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 440, 320, 40));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagensTelas/FarmaciaLogin2.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginnFarmacia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginnFarmacia().setVisible(true);
            }
        });
    }
