 ...
 */
public class TelaChamarTriagem extends javax.swing.JFrame {
// usando a variavel conexao do DAO
     ...
     */
    public TelaChamarTriagem() {
        initComponents();
        populaJComboBoxConvenio();
        conexao = Conexao.conector();
        setIcon();
        //ja traz selecionado a Sala do Login
        jcSala.setSelectedItem(Singleton.getSala());
    }
    ...
    private void chamarPacienteTelao() {
        try {
            ...
            sen.setLocal(jcSala.getSelectedItem().toString());
    ...
    private void initComponents() {
        ...
        setTitle("Chamada Senha Triagem");
        setFocusable(false);
        ...
        jcSala.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "< Selecione >" }));
        jcSala.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel4.setText("TIPO TRIAGEM:");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jcSala, javax.swing.GroupLayout.Alignment.LEADING, 0, 326, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jcSala, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel4))
                .addGap(18, 18, 18)
                .addComponent(btnOk)
        ...
        setSize(new java.awt.Dimension(505, 246));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaChamarTriagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaChamarTriagem().setVisible(true);
            }
        });
    }
