...
public class TelaVisualizarHistoricoClinico extends javax.swing.JFrame {
   ...
   public void listarDadosAnamnese() {
    ...
    TelaVisualizarAnamnese tela = new TelaVisualizarAnamnese();
    ...
    private void TabelaVisualizarHistoricoClinicoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaVisualizarHistoricoClinicoMouseClicked
        ...
        int index = TabelaVisualizarHistoricoClinico.getSelectedRow();
        TableModel model = TabelaVisualizarHistoricoClinico.getModel();
...
//        String Data = model.getValueAt(index, 1).toString();
        tela.listarAnamnese(NomePaciente);//aqui chamo o metodo atualiza Anamnese
...
//        tela.labelData.setText(Data);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVisualizarHistoricoClinico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
