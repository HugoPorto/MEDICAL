 ...
 */
public class TelaCadastroLeitosEnfermaria extends javax.swing.JFrame {
     ...
     */
    public TelaCadastroLeitosEnfermaria() {
        initComponents();
...
//    
    ...
    public void SalvarLeito() {
        Conexao conec = new Conexao();
        String sql = "insert into tb_leitosenfermaria(DataCadastro,leito,status)values(?,?,?)";
    ...
    public void alterarLeito() {
        Conexao conec = new Conexao();
        String sql = "update tb_leitosenfermaria set DataCadastro=?,leito=?,status=? where codigo=?";
    ...
    public void removerLeito() {
        Conexao conec = new Conexao();
        String sql = "delete from tb_leitosenfermaria where codigo=?";
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro Leitos Enfermaria");
        ...
        jLabel1.setText("Cadastro de Leitos Enfermaria");
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 4, 490, -1));
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 86, 490, -1));
        ...
        getContentPane().add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 324, 490, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 176, 490, 142));
        ...
        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 72, 490, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastroLeitosEnfermaria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroLeitosEnfermaria().setVisible(true);
            }
        });
    }
