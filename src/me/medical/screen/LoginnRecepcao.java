 ...
 */
public class LoginnRecepcao extends javax.swing.JFrame {
     ...
     */
    public LoginnRecepcao() {
        initComponents();
//        TextPrompt caixa = new TextPrompt("Insira o Usuario",txtUsuario);
//        TextPrompt caixa1 = new TextPrompt("Insira a Senha",txtSenha);
...
//                     + user, "Seja Bem Vindo " ,JOptionPane.INFORMATION_MESSAGE);
//            
//                     
                if (rs.next()) {
                    TelaPrincipalRecepcao tela = new TelaPrincipalRecepcao();
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 290, -1, -1));
        ...
        jPanel2.add(txtUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 310, 319, 40));

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Sua Senha");
        jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 360, -1, 23));
        ...
        jPanel2.add(txtSenha, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 390, 319, 40));
        ...
        jPanel2.add(btnEntrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 460, 320, 40));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagensTelas/LoginRecepção.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginnRecepcao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginnRecepcao().setVisible(true);
            }
        });
    }
