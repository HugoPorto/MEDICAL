 ...
 */
public class TelaCadastroSalaTriagem extends javax.swing.JFrame {
     ...
     */
    public TelaCadastroSalaTriagem() {
        initComponents();
        // chama classe de letras maiusculas
        txtTipoSala.setDocument(new UpperCaseField(100));
        setIcon();
...
//    
    private void habilitaCampos() {
        txtTipoSala.setEnabled(true);
        jTableSala.setEnabled(true);
        txtData.setEnabled(true);
    }

    private void desaabilitaCampos() {
        txtTipoSala.setEnabled(false);
        jTableSala.setEnabled(false);
    ...
    public void listarConsultorios() {
        ...
        model.setNumRows(0);
        String sql = "Select codigo,DataCadastro,tipoSala from tb_sala_triagem order by codigo";
        try {
    ...
    public void SalvarConvenio() {
        Conexao conec = new Conexao();
        String sql = "insert into tb_sala_triagem(DataCadastro,tipoSala)values(?,?)";

        try {
            pst = Conexao.conector().prepareStatement(sql);
            pst.setDate(1, convertDateSalvar(txtData.getDate()));
            pst.setString(2, txtTipoSala.getText());
            pst.execute();
            JOptionPane.showMessageDialog(rootPane, " Sala de Triagem " + txtTipoSala.getText().toUpperCase() + " salvo com sucesso.", "Inclusão", JOptionPane.INFORMATION_MESSAGE,icon);
            listarConsultorios();
        } catch (SQLException error) {
            JOptionPane.showMessageDialog(null, error);
        }finally {
    ...
    public void alterarConvenio() {
        Conexao conec = new Conexao();
        String sql = "update tb_sala_triagem set DataCadastro=?,tipoSala=? where codigo=?";
        ...
        try {
            ...
            pst.executeUpdate();
            JOptionPane.showMessageDialog(rootPane, " Sala de Triagem " + txtTipoSala.getText().toUpperCase() + " Atualizado com sucesso.", "Inclusão", JOptionPane.INFORMATION_MESSAGE,icon);
            listarConsultorios();
        } catch (SQLException error) {
            JOptionPane.showMessageDialog(null, error);
        }finally {
    ...
    public void removerConsultorio() {
        Conexao conec = new Conexao();
        String sql = "delete from tb_sala_triagem where codigo=?";

        try {
            pst = Conexao.conector().prepareStatement(sql);
            pst.setInt(1, Integer.parseInt(txtCodigo.getText()));
            pst.execute();
            JOptionPane.showMessageDialog(rootPane, " Sala de Triagem " + txtTipoSala.getText().toUpperCase() + " Excluido com sucesso.", "Inclusão", JOptionPane.INFORMATION_MESSAGE,iconExcluir);
            listarConsultorios();
        } catch (SQLException error) {
    ...
    public void mostrarItens() {
        int seleciona = jTableSala.getSelectedRow();
        txtCodigo.setText(jTableSala.getModel().getValueAt(seleciona, 0).toString());
        txtData.setDate(Utils.convertData(jTableSala.getModel().getValueAt(seleciona, 1).toString()));
        txtTipoSala.setText(jTableSala.getModel().getValueAt(seleciona, 2).toString());
    }
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro Sala Triagem");
        ...
        jLabel1.setText("Cadastro Sala de Triagem");
        ...
        jLabel3.setText("TIPO TRIAGEM:");

        txtTipoSala.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        txtTipoSala.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        txtTipoSala.setEnabled(false);
        txtTipoSala.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtTipoSalaFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtTipoSalaFocusLost(evt);
            }
        });
        txtTipoSala.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtTipoSalaKeyReleased(evt);
            }
        });
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(txtTipoSala, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(19, Short.MAX_VALUE))
        );

        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {txtCodigo, txtTipoSala});
        ...
        jTableSala.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Data Cadastro", "Sala Triagem"
            }
        ) {
        ...
        jTableSala.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                jTableSalaMouseReleased(evt);
            }
        });
        jTableSala.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTableSalaKeyReleased(evt);
            }
        });
    ...
    private void btnSairActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSairActionPerformed
        ...
        int sair = JOptionPane.showConfirmDialog(null, "DESEJA SAIR DA TELA SALA DE TRIAGEM ?", "ATENÇÃO", JOptionPane.YES_NO_OPTION);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        int i = jTableSala.getSelectedRow();
        if (i < 0) {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        if (txtTipoSala.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "Campo Tipo Sala é obrigatório", "Atenção", JOptionPane.WARNING_MESSAGE);
    ...
    private void jTableSalaMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableSalaMouseReleased
        jTableSala.setToolTipText(" Para habilitar o botao alterar e excluir clique no item que deseja!");
    }//GEN-LAST:event_jTableSalaMouseReleased

    private void txtTipoSalaFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTipoSalaFocusGained
        txtTipoSala.setBackground(new Color(252, 233, 163));
    }//GEN-LAST:event_txtTipoSalaFocusGained

    private void txtTipoSalaFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTipoSalaFocusLost
        txtTipoSala.setBackground(new Color(255, 255, 255));
    }//GEN-LAST:event_txtTipoSalaFocusLost

    private void jTableSalaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTableSalaKeyReleased
        mostrarItens();
    }//GEN-LAST:event_jTableSalaKeyReleased

    private void txtTipoSalaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTipoSalaKeyReleased
//        //campo aceita somente letras
//        txtTipoConsultorio.setText(txtTipoConsultorio.getText().replaceAll("[^A-Z]", ""));
    }//GEN-LAST:event_txtTipoSalaKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastroSalaTriagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroSalaTriagem().setVisible(true);
            }
        });
    }
