 ...
 */
public class LoginnEnfermagem extends javax.swing.JFrame {
...
//                     
                if (rs.next()) {
                    //salvando na memoria sala e usuario
                    Singleton.setSala(jCSala.getSelectedItem().toString());
                    Singleton.setUsuario(txtUsuario.getText());
                    
                    TelaPrincipalEnfermagemGeral tela = new TelaPrincipalEnfermagemGeral();
    ...
    private void initComponents() {
        ...
        jCSala.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "< Selecione Sala >" }));
        jPanel2.add(jCSala, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 420, 319, 33));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagensTelas/EnfermagemLogin.png"))); // NOI18N
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, 1380, 730));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginnEnfermagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginnEnfermagem().setVisible(true);
            }
        });
    }
...
public void populaJComboBoxSala() {
