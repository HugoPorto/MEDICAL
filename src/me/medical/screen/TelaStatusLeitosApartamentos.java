 ...
 */
public class TelaStatusLeitosApartamentos extends javax.swing.JDialog {
     ...
     */
    public TelaStatusLeitosApartamentos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public TelaStatusLeitosApartamentos(TelaGeralPacientesIternadosEnfermagem parent, boolean modal) {
        super(parent, modal);
        initComponents();
        populaJComboBoxleito();
    ...
    private void SalvarLeitos() {
        Conexao conec = new Conexao();
        String sql = "update tb_leitosapartamento set status=? where codigo=?";
...
//            listarCadastro();
    ...
    private void initComponents() {
        ...
        setTitle("Tela Status Leito Apartamento");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaStatusLeitosApartamentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaStatusLeitosApartamentos dialog = new TelaStatusLeitosApartamentos(new javax.swing.JFrame(), true);
