 ...
 */
public class TelaGeralPacientesAltaHospitalar extends javax.swing.JFrame {
     ...
     */
    public TelaGeralPacientesAltaHospitalar() {
        initComponents();
        listarCadastro();
        pintarColumnaTabla();
        setIcon();
    ...
    private void initComponents() {
        ...
        jXTitledPanel1.setTitle("CLIQUE SOBRE O PACIENTE DESEJADO PARA MUDAR O STATUS DO LEITO ");
...
//            listarCadastro();
    ...
    private void tabelaPacientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaPacientesMouseClicked
        ...
        if (evt.getClickCount() == 1) {
            // chama a tela ja com os dados
                    int sair = JOptionPane.showConfirmDialog(null, "Deseja mudar o STATUS do leito, deseja fazer agora ?", "ATENÇÃO", JOptionPane.YES_NO_OPTION);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaGeralPacientesAltaHospitalar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaGeralPacientesAltaHospitalar().setVisible(true);
            }
        });
    }
